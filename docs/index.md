...
<div class="phones">
  <figure><img src="/screenshots/welcome.png" alt="The welcome screen: create an account, restore a recovery phrase or connect a hardware wallet"><figcaption>Create a phrase, restore one, or use a hardware wallet.</figcaption></figure>
  <figure><img src="/screenshots/chats.png" alt="The chat list with the Status room"><figcaption>A fresh install: one room, for help and commands.</figcaption></figure>
  <figure><img src="/screenshots/status-room.png" alt="The Status room, with command chips above the composer"><figcaption>Commands live in chat. Type / to see them.</figcaption></figure>
</div>
