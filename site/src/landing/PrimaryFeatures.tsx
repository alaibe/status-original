...
import { type TargetAndTransition, AnimatePresence, motion } from 'framer-motion';
import { useDebouncedCallback } from 'use-debounce';

import { CircleBackground } from '@/landing/CircleBackground';
import { Container } from '@/landing/Container';
import { PhoneFrame, Screenshot } from '@/landing/PhoneFrame';
...
const bodyVariantForwards = (custom: CustomAnimationProps): TargetAndTransition => ({
  y: '100%',
    ...
    <TabGroup
      ...
      <div className="relative col-span-6">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <CircleBackground color="#7280CC" className="animate-spin-slower" />
        </div>
          ...
          <div
            ...
            <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
              ...
              <PhoneFrame className="relative mx-auto w-full max-w-[366px]">
                <Screenshot name={feature.screen} alt={feature.alt} />
              </PhoneFrame>
...
export function PrimaryFeatures() {
  return (
    <section id="features" aria-label="What the app does" className="bg-gray-900 py-20 sm:py-32">
      <Container>
