    ...
    typography: ({ theme }) => ({
      DEFAULT: {
        css: {
          ...
          '--tw-prose-links-hover': 'var(--color-brand-700)',
          ...
          '--tw-prose-invert-links': 'var(--color-brand-300)',
          '--tw-prose-invert-links-hover': 'var(--color-brand-200)',
          '--tw-prose-invert-links-underline':
            'color-mix(in oklab, var(--color-brand-400) 30%, transparent)',
